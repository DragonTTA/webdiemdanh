		...
		<div class="left-content">
			<div class="mother-grid-inner">
				...
				<ol class="breadcrumb" style="box-shadow: 0 0 10px rgba(5, 15,5,0.3);">
					<li class="breadcrumb-item"><a href="admin.php">Home</a> <a href="Files.php"><i class="fa fa-angle-right list-breadcrumb" style="font-size:18px; color:red;"> Class</i></a><i class="fa fa-angle-right list-breadcrumb" style="font-size:18px; color:blue;"> Class list</i></li>
				</ol>
				<?php
				//tạo kếy nối
				include('config.php');
				...
				<div id="Files">
					<div class="table" style=" text-align: center;" width=1258px;>
						<table border="1">
							<tr>
								<td width=100px; text-alie>STT</td>
								<td width=407px>Ảnh</td>
								<td width=350px>Tên lớp học</td>
								
								<td width=200px>Xoá</td>
								<td width=200px;>Chọn lớp học</td>
							...
							<?php foreach ($result as $key => $value) : ?>
								...
								<tr>
									...
									<td>
										<img src="../<?php echo $value['image_url']; ?>" alt="" width="300px">
									</td>
									<td width=200px>
									...
									<td>
										<a href="Files_delete_img.php?id=<?php echo $value['id']; ?>">Delete</a>
									</td>
									<td>
										<a href="Files_Check.php?id=<?php echo $value['id']; ?>">Chọn</a>
									</td>
