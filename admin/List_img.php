		...
		<div class="left-content">
			<div class="mother-grid-inner">
				...
				<ol class="breadcrumb" style="box-shadow: 0 0 10px rgba(5, 15,5,0.3);">
					<li class="breadcrumb-item"><a href="admin.php">Home</a> <i class="fa fa-angle-right list-breadcrumb" style="font-size:18px; color:red;"> Danh sách</i></li>
				</ol>
				<?php
				//tạo kếy nối
				if(isset($_SESSION['class']) =='Toán A1'){
				include('config.php');
				$sql = "SELECT * from `img_ta1` ";
				...
				// }
					...
					include('config.php');
					$sql1 = "SELECT * from `image_knm` ";
					$result = $conn->query($sql1);
					
				 }if($_SESSION['class'] == 'Phân tích thiết kế hệ thống'){
					$sql2 = "SELECT * from `image_pttk` ";
					$result = $conn->query($sql2); 
				 }
				if(($_SESSION['class'] != 'Kĩ năng mềm')&&($_SESSION['class'] != 'Phân tích thiết kế hệ thống')&&($_SESSION['class'] != 'Toán A1')){
					include('config.php');
				...
				<div id="Files">
					<div class="table" style=" text-align: center;" width=1258px;>
						<table border="1">
							<tr>
								<td width=100px; text-alie>ID</td>
								<td width=407px>Ảnh</td>
								<td width=350px>Họ và tên</td>
								<td width=200px>Xoá</td>
								<td width=200px>Check</td>
							</tr>
							<?php foreach ($result as $key => $value) : ?>
								...
								<tr>
									...
									<td>
										<img src="../<?php echo $value['image_url']; ?>" alt="" width="250px">
									</td>
									<td width="200px">
										<?php echo $value['name']; ?>
									</td>
									...
									<td>
										<a href="Delete_img.php?id=<?php echo $value['id']; ?>">Delete</a>
									</td>
									<td>
										<a href="Check.php?id=<?php echo $value['id']; ?>">Check</a>
									</td>
								</tr>
							<?php endforeach ?>
