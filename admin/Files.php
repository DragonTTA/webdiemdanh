...
<body>
		...
		<div class="left-content">
			<div class="mother-grid-inner">
				...
				<ol class="breadcrumb" style="box-shadow: 0 0 10px rgba(5, 15,5,0.3);">
					<li  class="breadcrumb-item"><a href="admin.php">Home</a>  <a href="Files.php"><i class="fa fa-angle-right list-breadcrumb" style="font-size:18px; color:red;"> Class</i></a></li>
				</ol>
        
 
    <h1 style="color: rgba(226, 19, 19, 0.8);">Upload Class</h1>
    ...
    <form method="POST" action="Files_upload.php" enctype="multipart/form-data">
			...
			<input type="text" name="class" placeholder="Tên lớp học" style="width:281px; height:38px;">
            <button type="submit" name="submit" value="Upload">Upload</button>
            <br>
            <a href="Files_List_img.php"><h2>Xem lớp học</h2></a>
          </form>
				<script>
